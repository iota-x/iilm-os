...
import { subjects as seedSubjects } from "@/data";
      ...
      <main className="mx-auto max-w-[1080px] px-5 pb-24">
        ...
        <section className="pt-10 sm:pt-16">
          ...
          <h1 className="mt-3 max-w-[18ch] font-serif text-[2.25rem] font-semibold leading-[1.1] tracking-tight sm:text-[3rem]">
            The whole semester, in one place that already knows your timetable.
          </h1>
          <p className="mt-5 max-w-[58ch] text-[length:var(--text-lead)] leading-relaxed text-muted">
            ...
            themselves to the lecture they came from, and a running count of where you stand.
            Built by a classmate, for this section.
          </p>
          <div className="mt-7 flex flex-wrap items-center gap-3">
            ...
            <p className="text-[length:var(--text-small)] text-subtle">
              Your college email, a password, your lab group. About a minute.
            </p>
          </div>
        </section>
        ...
        <section className="mt-16 max-w-[62ch]">
          ...
          <p className="mt-3 text-[length:var(--text-small)] leading-relaxed text-muted">
            ...
            where you post as yourself. The AI assistant runs on a free Google key you add
            yourself, so nobody&rsquo;s usage counts against anybody else&rsquo;s.
          </p>
          <Link
            href="/login?mode=up"
            className="mt-6 inline-flex items-center gap-2 rounded-[var(--radius-control)] bg-[var(--accent)] px-4 py-2.5 text-[length:var(--text-body)] font-medium text-[var(--accent-fg)] hover:opacity-90 focus-ring"
          >
            Create your account <ArrowRight size={16} />
          </Link>
        </section>
