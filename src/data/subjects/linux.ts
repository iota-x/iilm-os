...
Six answers. Learn them properly and the viva is free marks.`,
  ...
  gaps: [
    "No formal course plan — the marking scheme above is the standard IILM lab scheme (50 quiz + 50 execution/viva) inferred from your Applied Calculus Lab plan. Confirm with Dr. Pooja Batra.",
  ],
};
