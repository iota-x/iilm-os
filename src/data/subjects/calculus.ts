...
export const calculus: SeedSubject = {
  ...
  experiments: [
    ...
    },
    {
      ...
      co: "CO1",
      objective: "Numerically evaluate limits and explore types of discontinuity.",
      tasks: [
        "Write a program to numerically evaluate one-sided and two-sided limits.",
        "Plot the function and highlight limiting behaviour near the chosen point.",
        "Explore removable, jump and infinite discontinuities.",
      ],
      inMidsem: true,
    },
    {
      ...
      co: "CO1",
      objective: "Visualise the relationship between a function and its derivative.",
      tasks: [
        "Plot a function and its first derivative on the same graph.",
        "Analyse intervals of increase/decrease, maxima, minima and inflection points.",
      ],
      inMidsem: true,
    },
    {
